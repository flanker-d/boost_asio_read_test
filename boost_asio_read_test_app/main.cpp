...
{
  public:
    server(const int a_port, boost::asio::io_service::strand& a_strand, common::tcp::do_read_type_e a_type)
      : m_server(common::tcp::create_server(a_port, a_strand, a_type))
    {
    ...
    static server::ref create_server(const int a_port, boost::asio::io_service::strand& a_strand, common::tcp::do_read_type_e a_type)
    {
...
int main(int argc, char **argv)
{
  ...
  auto serv = server::create_server(9005, strand, common::tcp::do_read_type_e::read_until_eol);
  io_service.run();
  return 0;
